...
def create_app():
    ...
    def chunk():
        ...
        for i in range(int(len(entire_message)/10)):
            messages = entire_message[10*i:min(10*i+10, len(entire_message))] # use batch size of 10, and loop through each batch, until end of entire input
